                ...
                <div class="download-inner rounded mt-1" id="download_section">
                    <header class="header as-header header-layout1">
                        <div class="row align-items-center justify-content-between">
                            <div class="col-6">
                                <p class="mb-0"><b>رقم الفاتورة: {{str_pad($SellBookId->id +
                                    1,7,'0',STR_PAD_LEFT)}}</b></p>                            </div>
                            <div class="col-6">
                        ...
                        <div class="row justify-content-between">
                            <div class="col-auto">
                                <div class="booking-info">
                                    <p><b class="ms-2">بيع كتب مدرسية</b></p>
                                </div>
                            </div>
                            <div class="col-auto">
                                <div class="booking-info">
                                    <p><b class="ms-2">الطفل: {{$SellBookId->childs->name_ar}}</b></p>
                                </div>
                            </div>
                            <div class="col-auto">
                                <div class="booking-info">
                                    <p><b class="ms-2">المرحلة: {{$SellBookId->levels->name}}</b></p>
                                </div>
                            </div>
                        </div>
                    </header>
                        ...
                        <div class="div-table">
                            <table class="table invoice-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{$SellBook->books->name}}</td>
                                        <td>{{$SellBook->amount}}</td>
                                        <td>{{$SellBook->price}}</td>
                                        <td>{{$SellBook->subTotal}}</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
