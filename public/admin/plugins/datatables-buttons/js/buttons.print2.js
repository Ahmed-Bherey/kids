 ...
 */
let hotelDate = document.querySelector('#hotelDate').textContent;
let hotelName = document.querySelector('#hotelName').textContent;
let hotelAgent = document.querySelector('#hotelAgent').textContent;
(function(factory) {
